...
test("built-in icon catalog includes the supported external collections", () => {
  assert.deepEqual(
...
test("Iconify IDs round-trip through the stored Dock icon string", () => {
...
test("icon names stay human-readable without exposing library IDs", () => {
...
test("Phosphor weight variants are filtered from the unified picker", () => {

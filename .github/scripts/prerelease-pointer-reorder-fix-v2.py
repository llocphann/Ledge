...
old_marker = '.ledge-item-row-marker {\n  display: none;\n}\n'
new_marker = '.ledge-item-row-marker,\n.ledge-item-row-decorator {\n  display: none;\n}\n'
assert old_marker in css
css = css.replace(old_marker, new_marker, 1)
old_drag_css = '.ledge-item-drag-handle {\n  cursor: grab;\n}\n'
new_drag_css = '.ledge-item-drag-handle {\n  cursor: grab;\n  touch-action: none;\n  user-select: none;\n}\n'
assert old_drag_css in css
css = css.replace(old_drag_css, new_drag_css, 1)
...
tests = test_pattern.sub(lambda _: new_test, tests, count=1)
